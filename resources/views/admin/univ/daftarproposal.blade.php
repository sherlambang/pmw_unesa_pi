        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="{{ route('proposaladminuniv',['fakultas' => $fakultas, 'lolos' => 'tahap_2', 'perHalaman' => $perHalaman, 'period' => $period]) }}">Lolos
                        Tahap 2</a></li>
                <li><a href="{{ route('proposaladminuniv',['fakultas' => $fakultas, 'lolos' => 'tahap_2', 'perHalaman' => $perHalaman, 'period' => $period]) }}">Lengkap</a></li>
            </ul>
        </div>
        <div class="btn-group">
            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">
                ...
                <table class="table use-datatable">
                    ...
                    @foreach($proposal as $item)
                        <tr>
                            ...
                            <td>
                                @if(!is_null(\PMW\Models\Jenis::find($item->jenis_id)))
